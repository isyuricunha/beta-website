...
Our route data is in the form of a geoJson object. Check out my article [Building a mapping platform with React and Mapbox GL](https://beta.yuricunha.com/blog/trailroutes) for details how to parse geoJson from gpx files.
