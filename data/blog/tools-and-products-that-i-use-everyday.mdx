...
<Image
  alt={'Tools and products that I use everyday.'}
  src={
    '/static/images/blog/tools-and-products-that-i-use-everyday/tools-and-products-that-i-use-everyday.jpg'
  }
  width={1905 / 2}
  height={957 / 2}
  layout="responsive"
...
Tools come and go. But some things just stick. In the list below I grouped all the tools that I use for work and at home. If you have questions about anything on this list, feel free to [message me](mailto:me@yuricunha.com).
