...
description: >-
  um snippet bem detalhado para importar um pipe (function) no openwebui e usar
  um agent da mistral via api.
...
- `MISTRAL_API_KEY` válido (pegue em [https://console.mistral.ai/](https://console.mistral.ai/)).
...
1. vá para [https://console.mistral.ai/build/agents](https://console.mistral.ai/build/agents).
...
nunca cole sua chave em repositório público. em produção, prefira variáveis de ambiente e secrets
do seu deploy.
</blockquote>
