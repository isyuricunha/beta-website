...
description: >-
  un extrait détaillé pour importer un pipe (fonction) dans OpenWebUI et
  utiliser un agent Mistral via l'API.
tags:
  - openwebui
  - mistral
  - agents
...
<Callout type='warning'>
  Ne commitez jamais votre vraie clé API dans un dépôt public. En production, privilégiez les
  variables d'environnement et le gestionnaire de secrets de votre déploiement.
</Callout>
