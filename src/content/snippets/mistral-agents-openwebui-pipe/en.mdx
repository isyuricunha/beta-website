...
description: >-
  a detailed snippet to import a pipe (function) into openwebui and use a
  mistral agent via the api.
...
never commit your real api key to a public repository. in production, prefer environment variables
and your deployment secrets manager.
</blockquote>
