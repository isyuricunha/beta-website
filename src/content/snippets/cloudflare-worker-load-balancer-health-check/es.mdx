---
title: >-
  Balanceador de Carga de Cloudflare Worker con Comprobaciones de Estado
  (Gratis)
description: >-
  Un balanceador de carga práctico y gratuito usando Cloudflare Workers +
  Cloudflare Tunnel, con comprobaciones periódicas de estado y conmutación por
  error automática.
tags:
  - cloudflare
  - workers
