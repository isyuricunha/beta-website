...
description: >-
  Un équilibreur de charge pratique et gratuit utilisant Cloudflare Workers +
  Cloudflare Tunnel, avec des vérifications d'état périodiques et un basculement
  automatique.
tags:
  - cloudflare
  - workers
