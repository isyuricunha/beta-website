...
description: >-
  Eine kurze Anleitung zum Einstellen des Linux-CPU-Governors auf »schedutil«
  für eine ausgewogene Balance zwischen Leistung und Energieeffizienz, inklusive
  Beibehaltung der Einstellungen nach einem Neustart.
