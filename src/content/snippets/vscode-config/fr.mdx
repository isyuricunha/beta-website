...
description: >-
  Configuration complète de VSCode/VSCodium avec une liste d'extensions et une
  sauvegarde des paramètres pour une migration facile entre les installations.
tags:
  - vscode
  - vscodium
  - configuration
