...
description: >-
  Un bot Discord complet et asynchrone qui s'intègre à une instance locale
  d'Ollama et suit l'historique des utilisateurs dans SQLite.
...
Ne commitez jamais votre token Discord réel dans un dépôt public. Utilisez des variables
d'environnement (par exemple, `python-dotenv`) pour les déploiements en production.
</blockquote>
